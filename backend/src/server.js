...
cloudinary.config({
  cloud_name: process.env.CLOUDINARY_CLOUD_NAME || 'iujquua4',
  api_key: process.env.CLOUDINARY_API_KEY || '175652616715822',
  api_secret: process.env.CLOUDINARY_API_SECRET || 't07mNXes5hyDeNU1aEjemgwyYQ4'
});
